            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="user-bookChart"><i class="fa fa-circle-o"></i>图书统计</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body chart-responsive">
                            <div class="chart" id="class-chart" style="height: 300px; position: relative;"></div>
                        </div>
                        <!-- /.box-body -->
                    </div>
