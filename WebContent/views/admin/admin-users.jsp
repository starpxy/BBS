...
<div class="wrapper">
                                ...
                                <table id='booktable' class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="user-password"><a class="alter-password"><span>${password }</span><input
                                                type="text" size="10" name="user-password" style="display: none"
                                                value="1234666"></a></td>
                                        ...
                                        <td class="options">
                                            ...
                                            <a data-toggle="tooltip" data-placement="left"
                                               title="指派该用户为管理员" class="become-admin"><span
                                            ...
                                            <a data-toggle="tooltip" data-placement="left"
                                               title="删除该用户" class="delete-user"><i
    ...
    <div id="recomfrebox" style="display: none; margin: 20px">
        <div class="form-group">
            <label>更改还书提醒</label>
            <select id="recomfreselect" class="form-control">
...
//
         ...
         if (!ispassadmin){
             ...
             layer.prompt({
                 ...
                 if (value == "123") {
                     ...
                     layer.msg("密码错误", {anim: 6, icon: 2, time: 1000});
                 }
             });
        ...
        $("input[name='user-password']").keydown(function (e) {
            ...
            if (e.keyCode == 13) {
                ...
                $(this).hide();
                layer.msg("成功", {anim: 1, icon: 1, time: 1000});
            }
        });
            ...
            if (!ispassadmin){
                ...
                layer.prompt({
                    ...
                    if (value == "123") {
                        ...
                        layer.msg("成功指派该用户为管理员", {anim: 1, icon: 1, time: 1000});
                ...
                $(this).parent().siblings('.user-role').text("管理员");
                layer.msg("成功指派该用户为管理员", {anim: 1, icon: 1, time: 1000});
        ...
        $(".become-normal").click(function () {
            ...
            layer.msg("成功该用户设为一般用户", {anim: 1, icon: 1, time: 1000});
...
//            layer.msg("alter-recom-fre is clicked");
            ...
            layer.open({
                ...
                yes: function (index) {
                    //TODO
                    layer.close(index);
                    layer.msg("更改成功", {anim: 1, icon: 1, time: 1000});
